...
#define SYSCALL_SET_WORKLOAD 64
#define SYSCALL_CURSOR_COL 65
#define SYSCALL_CURSOR_ROW 66
#define SYSCALL_TASK_SHOW 67
#define SYSCALL_SET_AFFINITY 68
#define SYSCALL_EXEC_WITH_AFF 69
