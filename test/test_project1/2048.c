...
unsigned int simple_itoa(
    long value, unsigned int radix, unsigned int uppercase, unsigned int unsig, char* buffer,
    ...
    for (i = (pbuffer - buffer); i < zero_pad; i++) *(pbuffer++) = '0';
...
void pickColor(int n) {
    if (n == -1) bios_putstr("\033[39;49m");
    if (n == 0) bios_putstr("\033[100m");
    if (n == 2) bios_putstr("\033[97;41m");
    if (n == 4) bios_putstr("\033[97;42m");
    if (n == 8) bios_putstr("\033[97;43m");
    if (n == 16) bios_putstr("\033[97;44m");
    if (n == 32) bios_putstr("\033[97;45m");
    if (n == 64) bios_putstr("\033[97;46m");
    if (n == 128) bios_putstr("\033[30;101m");
    if (n == 256) bios_putstr("\033[30;102m");
    if (n == 512) bios_putstr("\033[30;103m");
    if (n == 1024) bios_putstr("\033[30;104m");
    if (n == 2048) bios_putstr("\033[30;105m");
}
